...
void Plane::calculateVertices()
{
	...
	// Use the same vertex positions for both sides, but define separate indices
	vertices =
	{
	...
	index_list =
	{
		...
		// Indices for the back face (in reverse order for correct winding)
		2, 1, 0,
		2, 3, 1
	};
}
