...
VertexBuffer* RenderSystem::createVertexBuffer(std::vector<vertex>& list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code, size_t size_byte_shader)
{
...
IndexBuffer* RenderSystem::createIndexBuffer(std::vector<unsigned int>& index_list, UINT size_list)
{
	IndexBuffer* ib = nullptr;
	try
	{
		ib = new IndexBuffer(index_list, size_list, this);
	}
	catch(...) {}
	return ib;
}
