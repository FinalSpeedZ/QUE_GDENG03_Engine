...
bool VertexBuffer::load(std::vector<vertex>& list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code, size_t size_byte_shader)
{
	...
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		{ "COLOR", 0,  DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(vertex, rgba),D3D11_INPUT_PER_VERTEX_DATA ,0},
		{ "COLOR", 1,  DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(vertex, rgba1),D3D11_INPUT_PER_VERTEX_DATA ,0}
	};
